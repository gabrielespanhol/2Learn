...
const AboutUsText({ Key? key }) : super(key: key);
  ...
  text:  TextSpan(
    text: 'Somos uma empresa formada por um grupo de estudantes e amigos que viram uma necessidade no meio em que vivemos.\n\nCom dificuldade em encontrar um serviço centrado em nossas necessidades de aprendizados particulares.\n\nCom isso, formamos a ',
    style: TextStyle(
    ...
    children: const <TextSpan>[
      ...
      TextSpan(text: 'afim de ajudar aqueles que, como nós, gostariam de ter a liberdade de escolher o que considera melhor e mais confortável para si em um local seguro e confiável, com a transparência de serviço que precisamos.\n\nBuscamos atender não somente os estudantes, mas também aqueles que com seu conhecimento desejam ajudar o próximo e com isso ganhar uma renda extra.'),
    ],
  ),
),
            )
